...
import com.huahui.datasphere.mdm.system.util.AbstractJaxbUtils;

import com.huahui.datasphere.mdm.security.Security;

/**
 * @author theseusyang on Oct 4, 2019
...
public final class SecurityJaxbUtils extends AbstractJaxbUtils {
    ...
    private static final com.huahui.datasphere.mdm.security.ObjectFactory SECURITY_FACTORY =
            new com.huahui.datasphere.mdm.security.ObjectFactory();

    public static com.huahui.datasphere.mdm.security.ObjectFactory getSecurityFactory() {
