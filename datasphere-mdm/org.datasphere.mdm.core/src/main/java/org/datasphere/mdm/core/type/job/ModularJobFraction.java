 ...
 */
public abstract class ModularJobFraction {
    /**
     ...
     */
    protected ModularJobFraction(String id, Collection<JobParameterDescriptor<?>> parameters) {
        super();
    ...
    ///////////////////////////////////////////////////////////////////////
    /**
     * Run before job is actually executed as part of {@link org.springframework.batch.core.JobExecutionListener}.
     * @param job the job execution object
     */
    ...
    /**
     * Run after job has been actually executed as part of {@link org.springframework.batch.core.JobExecutionListener}.
     * @param job the job execution object
     */
