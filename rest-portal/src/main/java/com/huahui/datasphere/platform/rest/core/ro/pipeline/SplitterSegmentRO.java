 ...
 */
public class SplitterSegmentRO extends AbstractOutcomeSegmentRO {
    /**
     * Constructor.
     */
     ...
     */
    public SplitterSegmentRO(OutcomesPipelineConnection connection) {
        super(connection);
    }
    /**
     * Constructor.
     * @param segment
     */
    public SplitterSegmentRO(Splitter<?, ?> segment) {
        super(segment);
    }
}
