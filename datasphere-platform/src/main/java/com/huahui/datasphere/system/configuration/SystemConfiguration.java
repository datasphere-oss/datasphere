...
public class SystemConfiguration extends AbstractConfiguration {
    ...
    public HazelcastInstance hazelcastInstance(
        ...
        final Config datasphereHzConfig = new Config()
                .setInstanceName("datasphere");

        final JoinConfig join = datasphereHzConfig.getNetworkConfig()
                .setPort(port)
        ...
        return Hazelcast.getOrCreateHazelcastInstance(datasphereHzConfig);
    }
