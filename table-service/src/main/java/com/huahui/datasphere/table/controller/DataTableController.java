...
import com.huahui.datasphere.table.domain.CustomTable;
import com.huahui.datasphere.table.domain.CustomTableColumn;
import com.huahui.datasphere.table.domain.DMDataTable;
import com.huahui.datasphere.table.jdbc.database.conf.Dbtype;
import com.huahui.datasphere.table.jdbc.database.jdbc.DatabaseWrapper;
...
import com.huahui.datasphere.table.utils.StringUtil;
...
//
	...
	@ApiOperation(value = "通过分类ID查找数据表信息.", response = List.class)
	...
	@ApiOperation(value = "获取加工数据表信息.", response = DMDataTable.class)
	...
	@ApiOperation(value = "获取加工数据表的字段信息.", response = DMDataTable.class)
